...
var UserSchema = new mongoose.Schema({
  username: {type: String, lowercase: true, unique: true, required: [false, "can't be blank"], match: [/^[a-zA-Z0-9]+$/, 'is invalid'], index: true},
...
UserSchema.methods.toAuthorJSONFor = function(user){
  return {
    username: this.username,
    bio: this.bio,
    role: this.role,
